...
export enum NaturezaOperacao {
  // Entrada
  COMPRA_VEICULO_PARA_ESTOQUE = 'COMPRA DE VEICULO PARA ESTOQUE',
  ENTRADA_CONSIGNACAO = 'ENTRADA EM CONSIGNAÇÃO',
  COMPRA_DEFINITIVA_CONSIGNACAO = 'COMPRA DEFINITIVA DE VEICULO EM CONSIGNAÇÃO',
  DEVOLUCAO_VENDA = 'DEVOLUÇÃO DE VENDA',
  ENTRADA_CONTRATO_COMISSAO = 'ENTRADA PARA CONTRATO EM COMISSÃO',
