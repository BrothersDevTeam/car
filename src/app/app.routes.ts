...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'compras',
        loadChildren: () => import('./pages/compras/compras.routes').then((m) => m.COMPRAS_ROUTES),
      },
      {
        path: 'financial',
        loadChildren: () => import('./pages/financial/financial.routes').then((m) => m.FINANCIAL_ROUTES),
      },
      {
        path: 'reports',
