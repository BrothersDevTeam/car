  ...
  template: `
    ...
    <mat-dialog-content class="dialog-content">
      <div class="transaction-info">
        ...
        <p><strong>Total Pago:</strong> <span class="text-success">{{ data.transaction.totalPaid | currency:'BRL' }}</span></p>
        <p><strong>Saldo Devedor:</strong> <span class="text-danger">{{ data.transaction.balanceDue | currency:'BRL' }}</span></p>
      </div>
        ...
        <div class="table-container">
          <table mat-table [dataSource]="payments" class="mat-elevation-z0 w-100">
            ...
            <ng-container matColumnDef="discountAmount">
              ...
              <td mat-cell *matCellDef="let p" class="text-info">
                -{{ p.discountAmount | currency:'BRL' }}
              </td>
            </ng-container>
...
export class TransactionPaymentsHistoryDialogComponent implements OnInit {
  ...
  getMethodLabel(method: string): string {
    switch (method) {
      ...
      case 'BANK_TRANSFER': return 'TED/DOC';
